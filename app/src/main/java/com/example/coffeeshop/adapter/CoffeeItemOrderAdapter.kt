...
class CoffeeItemOrderAdapter(
    private val coffeeList: ArrayList<Coffee>,
    private val context: Context
) :
    RecyclerView.Adapter<CoffeeItemOrderAdapter.CoffeeItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoffeeItemViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.coffee_item_order, parent, false)
